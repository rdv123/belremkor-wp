      ...
      <div class="about">
         <div class="container-fluid">
            <div class="row d_flex">
               <div class="col-md-4">
                  <div class="titlepage">
                     <h2 class="h2-about">О нашей компании</h2>
                     <span>Компания ООО БелРемКор осуществляет помощь по сбору предпроектной документации. 
                        ...
                        работ и сдаче объекта в эксплуатацию по следующим направлениям: 
                        <ul>
                              <li>
                         ...
                         Компания имеет собственную электроизмерительную лабораторияю,что позволяет производить электрофизические 
                     ...
                     <div class="col-md-4">
                        <div class="titlepage">
                           ...
                           <!-- <span>
                              <ol>
                                 <li>
                                    На сегодняшний день компания обладает значительным штатом ведущих специалистов в области проектирования газораспределительных 
                                    систем и газопотребления. ООО БелРемКор удалось объединить множество первоклассных профессионалов, для которых качество - это не пустой звук.
                                    Мы прекрастно понимаем, что созданный нами продукт - это наше лицо!
                     
                                 </li>
                                 <li>
                                 При разработке проектов используются только современное программное обеспечение
                                 и технологии. Благодаря чему, мы достигаем высокого качества проектирования в минимальные сроки.
                                 </li>
                                 <li>
                                 Неважно, насколько вы хорошо осведомлены в вопросах теплоэнергетики и работы котельных, 
                                 специалисты компании всегда помогут Вам реализовать ваше желание с минимальными затратами и
                                 максимальной эффективностью
                                 </li>
                                 <li>
                                    Все наши компетенции не голословны. Они подтверждены лицензиями и сертификататами в соответствии с
                           ...
                           <span>
                              <div class="benefits">
                                 <div class="num_benefits">1.</div><p class = "p-benefits">На сегодняшний день компания обладает значительным штатом ведущих специалистов в области проектирования газораспределительных 
                                    систем и газопотребления. ООО БелРемКор удалось объединить множество первоклассных профессионалов, для которых качество - это не пустой звук.
