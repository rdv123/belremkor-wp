         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-6 col-md-7 ">
                  <div class="titlepage">
                     <h2>Коротко о нас</h2>
                     <p>Компания ООО БелРемКор осуществляет помощь по сбору предпроектной документации. Оказывает услуги по проектированию, выполнению строительно-монтажных и пусконаладочных работ и сдаче объекта в эксплуатацию по следующим направлениям: водоснабжение и канализация, электроснабжение, газоснабжение, отопление и вентиляция. Компания имеет собственную электроизмерительную лабораторияю,что позволяет производить электрофизические измерения (ЭФИ) на любых видах объектов. Наши специалисты высококвалифицированны и имеют большой опыт работы в сфере электроизмерений и допущены к работе с повышенным напряжением.</p>
                     <div class="award">
